...
const aiTools = [
    { title: "Générateur de Bio", description: "Créez une biographie captivante et unique.", href: "/account/ai-studio/bio" },
    { title: "Idées de Contenu", description: "Trouvez l'inspiration pour vos prochaines publications.", href: "/account/ai-studio/ideas" },
    { title: "Générateur d'Images", description: "Créez des visuels uniques pour vos contenus.", href: "/account/ai-studio/image" },
    { title: "Studio IA Complet", description: "Générez images, vidéos et voix par IA.", href: "/account/ai-studio", icon: Sparkles },
]
...
export default function CreatorDash() {
  return (
    <div className="space-y-8">
        <div>
            <h1 className="text-3xl font-bold font-headline">Tableau de Bord Créateur</h1>
            <p className="text-muted-foreground">Voici un aperçu de votre activité sur GoMoodX.</p>
        </div>
