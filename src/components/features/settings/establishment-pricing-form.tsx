...
import type { User, EstablishmentPricing } from '@/lib/types';
...
interface EstablishmentPricingFormProps {
    user: User;
}

export function EstablishmentPricingForm({ user }: EstablishmentPricingFormProps) {
                ...
                <Card>
                    ...
                    <CardContent className="space-y-8">
                        <div className="space-y-2">
                            <Label htmlFor="basePricePerHour">Prix de base par heure (Chambre Standard)</Label>
